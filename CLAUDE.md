...
## Project Overview
KAOS is a local-first multi-agent orchestration framework (v0.5.2). Every agent gets an isolated, auditable virtual filesystem backed by a single SQLite `.db` file.
